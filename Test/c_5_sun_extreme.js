...
describe("Test Case C5", function(){
    it("North Pole", async function(){
        // Launch the browser
        ...
        await driver.findElement(By.id("latitude")).sendKeys("90.0");
        await driver.findElement(By.id("longitude")).sendKeys("0.0");
